...
if(get_theme_option('buyer_username')!='' && get_theme_option('buyer_api')!='') PixelentityThemeUpdate::init(get_theme_option('buyer_username'),get_theme_option('buyer_api'),'PixelBook');
